...
const Speaker = memo(function Speaker({ speaker, updateRecord, insertRecord, deleteRecord }) {
    ...
    return (
        ...
        >
            <div key={speaker.id} className="col-xs-12 col-sm-12 col-md-6 col-lg-4">
...
function areSpeakerEqual(prevProps, currentProps) {
    return (prevProps.speaker.favorite === currentProps.speaker.favorite);
}
